                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.employ.store')}}" method="POST"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" step=".01" value="" id="salary"
                                                                   class="form-control" 
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <a href="{{ route('admin.employ') }}" class="btn btn-warning">
                                                     تراجع
                                                </a>
