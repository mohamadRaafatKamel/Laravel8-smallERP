...
@section('content')
<?php 
if(! $permissoin = \App\Models\Role::havePremission(['employ_idt']))
    $readonly="readonly";
else 
    $readonly="";
?>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        @if ($permissoin)
                                        <form class="form" action="{{route('admin.employ.update',$datas -> id)}}" method="POST"
                                        ...
                                        @endif
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="patment"> {{ __('Patment') }} </label>
                                                            <select name="patment" id="patment"
                                                                    class="form-control @error('patment') is-invalid @enderror">
                                                                <option value="1"
                                                                        @if($datas -> patment == "1") selected @endif>{{ __('Daily') }}</option>
                                                                <option value="2"
                                                                        @if($datas -> patment == "2") selected @endif>{{ __('Monthly') }}</option>
                                                            </select>
                                                            @error('patment')
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" step=".01" value="{{ $datas -> salary }}" 
                                                                    id="salary" class="form-control" {{ $readonly }}
